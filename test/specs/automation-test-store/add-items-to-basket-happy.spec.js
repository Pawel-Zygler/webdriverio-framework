...
describe("BASKET - happy path", () => {
  ...
  xdescribe('ADD T-SHIRTS', () => {
    ...
    it.only('adds a t-shirt and checks if items are in cart', async () => {
      const productOne = 'Designer Men Casual Formal Double Cuffs Grandad Band Collar Shirt Elegant Tie';
      const productTwo = 'Casual 3/4 Sleeve Baseball T-Shirt';
      const errorInName = 'Designer Men Cassual Formal Double Cuffs Grandad Band Collar Shirt Elegant Tie';
      ...
      } else {console.log('row is undefined');}
